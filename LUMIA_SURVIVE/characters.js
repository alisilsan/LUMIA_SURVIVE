    ...
    aiden: {
      ...
      skills: {
        s1: {
          ...
          unlockLevel: 1,
          levels: [
            { damage: 16, cooldown: 4, desc: '쿨다운 4.0초 · 피해 16' },
            { damage: 20, cooldown: 3.5, desc: '쿨다운 3.5초 · 피해 20' },
            { damage: 25, cooldown: 3, desc: '쿨다운 3.0초 · 피해 25' },
            { damage: 30, cooldown: 2.5, desc: '쿨다운 2.5초 · 피해 30' },
            { damage: 36, cooldown: 2, slow: true, desc: '쿨다운 2.0초 · 피해 36 · 적중 시 0.5초간 이동속도 30% 감소' },
          ],
        },
        s2: {
          name: '전하 소산',
    ...
    celine: {
      ...
      skills: {
        s1: {
          ...
          unlockLevel: 1,
          levels: [
            { damage: 22, cooldown: 7, radius: 70, desc: '쿨다운 7.0초 · 피해 22' },
            { damage: 28, cooldown: 6.5, radius: 75, desc: '쿨다운 6.5초 · 피해 28' },
            { damage: 35, cooldown: 6, radius: 80, desc: '쿨다운 6.0초 · 피해 35' },
            { damage: 43, cooldown: 5.5, radius: 85, desc: '쿨다운 5.5초 · 피해 43' },
            { damage: 52, cooldown: 5, radius: 90, multiHit: 3, desc: '쿨다운 5.0초 · 피해 52 · 3회 연속 폭발' },
          ],
        },
        s2: {
          name: '블라스트 웨이브',
        ...
        s3: {
          ...
          unlockLevel: 5,
          levels: [
            { damage: 20, cooldown: 30, radius: 110, desc: '반경 110 · 쿨다운 30초 · 피해 20' },
    ...
    jackie: {
      ...
      skills: {
        s1: {
          ...
          unlockLevel: 1,
          levels: [
            { damage: 18, cooldown: 5, coneDeg: 60, desc: '쿨다운 5.0초 · 피해 18 · 범위 60°' },
            { damage: 23, cooldown: 4.5, coneDeg: 70, desc: '쿨다운 4.5초 · 피해 23 · 범위 70°' },
            { damage: 29, cooldown: 4, coneDeg: 80, desc: '쿨다운 4.0초 · 피해 29 · 범위 80°' },
            { damage: 36, cooldown: 3.5, coneDeg: 90, desc: '쿨다운 3.5초 · 피해 36 · 범위 90°' },
            { damage: 44, cooldown: 3, coneDeg: 100, slow: true, desc: '쿨다운 3.0초 · 피해 44 · 범위 100° · 적중 시 3초간 이동속도 30% 감소' },
          ],
        },
        s2: {
          name: '피의 축제',
        ...
        s3: {
          name: '습격자의 숨결',
          desc: '가장 가까운 적 무리 한가운데로 도약해 강하게 내리쳐 광역 피해와 스턴을 입힙니다.',
          unlockLevel: 5,
          levels: [
            { damage: 30, cooldown: 15, desc: '쿨다운 15초 · 피해 30 · 1초 스턴' },
            { damage: 38, cooldown: 13, desc: '쿨다운 13초 · 피해 38 · 1초 스턴' },
            { damage: 47, cooldown: 12, desc: '쿨다운 12초 · 피해 47 · 1초 스턴' },
            { damage: 58, cooldown: 11, desc: '쿨다운 11초 · 피해 58 · 1초 스턴' },
            { damage: 70, cooldown: 10, bloodZone: true, desc: '쿨다운 10초 · 피해 70 · 1초 스턴 · 착지 지점에 3초간 피의 장판 생성(장판 위 흡혈 +3%, 장판 내부 적 출혈)' },
          ],
        },
      },
    },
