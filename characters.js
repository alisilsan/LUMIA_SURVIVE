      ...
      skills: {
        ...
        s2: {
          ...
          levels: [
            ...
            { lifesteal: 0.055, desc: '광기 상태 흡혈 5.5% (몬스터 50마리 처치마다 5초간 발동)' },
            { lifesteal: 0.06, desc: '광기 상태 흡혈 6% (몬스터 50마리 처치마다 5초간 발동)' },
            { lifesteal: 0.065, desc: '광기 상태 흡혈 6.5% (몬스터 50마리 처치마다 5초간 발동)' },
            { lifesteal: 0.07, desc: '광기 상태 흡혈 7% (몬스터 50마리 처치마다 5초간 발동)' },
          ],
        },
        s3: {
          name: '습격자의 숨결',
          desc: '반경 300 내 적 위치에 3초간 피의 장판을 생성합니다. 장판은 1초마다 적 최대체력의 5% 피해를 주며, 피해를 준 대상의 최대체력 일부를 흡수합니다.',
          unlockLevel: 5,
          levels: [
            { cooldown: 20, zones: 1, drainPct: 0.003, desc: '쿨다운 20초 · 장판 1개 · 매초 적 최대체력의 5% 피해 + 0.3% 흡수' },
            { cooldown: 18, zones: 2, drainPct: 0.003, desc: '쿨다운 18초 · 장판 2개 · 매초 적 최대체력의 5% 피해 + 0.3% 흡수' },
            { cooldown: 17, zones: 2, drainPct: 0.005, desc: '쿨다운 17초 · 장판 2개 · 매초 적 최대체력의 5% 피해 + 0.5% 흡수' },
            { cooldown: 16, zones: 3, drainPct: 0.005, desc: '쿨다운 16초 · 장판 3개 · 매초 적 최대체력의 5% 피해 + 0.5% 흡수' },
            { cooldown: 15, zones: 3, drainPct: 0.007, desc: '쿨다운 15초 · 장판 3개 · 매초 적 최대체력의 5% 피해 + 0.7% 흡수' },
          ],
        },
      },
    },
